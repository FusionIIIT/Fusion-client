    ...
    <Grid gutter="lg" className={classes.layout}>
        ...
        <Paper withBorder p="lg" radius="md" className={classes.controls}>
          <Stack gap="md">
            ...
            <TextInput
              ...
              rightSection={fetchingStudent ? <Loader size={16} /> : undefined}
            />
            <Button
              variant="light"
      ...
      <Grid.Col span={{ base: 12, xl: 8 }}>
        {preview ? (
          <div className={classes.previewViewport}>
            <article className={classes.certificate}>
              ...
              <p className={classes.body}>
                ...
                <strong>Mr. {preview.student.father_name}</strong> is a student
                of <strong>{preview.student.year_ordinal} Year</strong> (
              ...
              {preview.isInternship && (
                <p className={classes.note}>
                  Note: No objection certificate will be issued by the placement
                  cell.
                </p>
              )}
          ...
          >
            Enter a roll number, fetch the student, select a purpose, and choose
            Preview. The certificate can then be printed or downloaded as PDF.
          </Alert>
        )}
      </Grid.Col>
    </Grid>
