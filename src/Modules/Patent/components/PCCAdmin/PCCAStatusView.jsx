  ...
  return (
    <Container className="form-container" size="lg">
      ...
      <Card className="form-section">
        ...
        <div className="form-field">
          <Text className="field-heading">Proof of Concept:</Text>
          <div className="field-value">
            {applicationData.section_I?.poc_details ? (
              <FileDownloadButton
                fileUrl={`${host}${applicationData.section_I.poc_details}`}
                fileName="POC-File"
                disabled={!applicationData.section_I?.poc_details}
              />
            ) : (
              "No file available"
            )}
        ...
        <div className="form-field">
          ...
          <div className="field-value">
            {applicationData.section_II?.source_agreement ? (
              <FileDownloadButton
                fileUrl={`${host}${applicationData.section_II.source_agreement}`}
        ...
        <div className="form-field">
          ...
          <div className="field-value">
            {applicationData.section_II?.mou_file ? (
              <FileDownloadButton
                fileUrl={`${host}${applicationData.section_II.mou_file}`}
