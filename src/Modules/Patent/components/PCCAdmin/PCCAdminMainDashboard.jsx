...
import CommunicationLogs from "./ManageAttorney/CommunicationLogs.jsx";
import AnalyticsDashboard from "../PccAdmin/Analytics/AnalyticsDashboard.jsx";
import SearchApplications from "../Common/Search/SearchApplications.jsx";
...
const TAB_ITEMS = [
  ...
  { title: "Communication Logs", id: "4" },
  { title: "Notifications", id: "5" },
  { title: "Search Applications", id: "6" },
  { title: "Analytics", id: "7" },
];

function PCCAdminMainDashboard() {
  ...
  const renderTabContent = () => {
    ...
    switch (activeTab) {
      ...
      case "4":
        return <CommunicationLogs setActiveTab={setActiveTab} />;
      case "5":
...
export default PCCAdminMainDashboard;
