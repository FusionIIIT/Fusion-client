    ...
    <Card id="pms-application-card" shadow="sm" p="lg" radius="md" withBorder>
      ...
      <div id="pms-app-card-info">
        ...
        {tokenNumber ? (
          <div id="pms-info-item">
            <Key size={18} />
            <Text id="pms-info-text">Application No: {tokenNumber}</Text>
          </div>
        ) : (
          <div id="pms-info-item">
            <Hourglass size={18} />
            <Text id="pms-info-text">Application No: Awaiting assignment</Text>
          </div>
        )}
        ...
        <div id="pms-card-badge-container">
          <Badge color={getStatusColor(displayStatus)} size="lg">
            {displayStatus}
          </Badge>
        </div>
      </div>
      ...
      >
        <div id="pms-application-view-detail-header">
          ...
          <div style={{ display: "flex", gap: "0.75rem", flexWrap: "wrap" }}>
            {!["Patent Granted", "Patent Refused", "Withdrawn"].includes(
              status,
            ) && (
              <Button
                color="red"
            ...
            {["Reviewed by PCC Admin", "Needs Revision"].includes(status) && (
              <Button
                color="orange"
                variant="filled"
                onClick={handleEditAndResubmitApplication}
                disabled={withdrawing}
              >
                Edit & Resubmit
              </Button>
        ...
        <div>
          ...
          >
            <Grid>
              ...
              <Grid.Col span={12} md={4} className="pms-form-field-container">
                <FormField label="Status:" value={displayStatus} />
              </Grid.Col>
              <Grid.Col span={12} md={4} className="pms-form-field-container">
