...
function ApplicationDetailPage() {
  ...
  const handleInterviewSave = async () => {
    ...
    try {
      await placementApi.scheduleApplicationInterview(
        applicationId,
        interviewForm,
      );
      notifications.show({
      ...
      <Stack gap="lg">
        <Group justify="space-between">
          <Button
            ...
            onClick={() =>
              navigate(`/placement-cell/view?jobId=${application.schedule_id}`)
            }
          >
            Back to applicants
          </Button>
          ...
          <Card withBorder radius="md" padding="lg">
            <Stack gap="md">
              ...
              <Text>
                ...
                {application.company.role || "Role not specified"}
              </Text>
            ...
            <Group justify="space-between" align="flex-start">
              <div>
                ...
                <Text size="sm" c="dimmed">
                  Every saved interview step is surfaced here as frontend
                  evidence: schedule, candidate details, result, and feedback.
                </Text>
              </div>
              <Badge color="teal">
            ...
            <Stack gap="lg">
              ...
              <Card withBorder radius="md" padding="lg">
                <Stack gap="sm">
                  ...
                  <Text size="sm" c="dimmed">
                    Saving this form records the interview step in the system
                    with date/time, result, and remarks.
                  </Text>
                  <TextInput
                    label="Round"
