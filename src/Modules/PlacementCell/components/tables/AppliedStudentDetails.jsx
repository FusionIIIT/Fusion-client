/* eslint-disable react/prop-types, react/no-unstable-nested-components, no-use-before-define */
...
function JobApplicationsTable() {
  ...
  const handleDeleteApplication = async (applicationId, studentName) => {
    ...
    try {
      ...
      showApiError({
        ...
        authorizationFallback:
          "Only placement officer users can delete applications.",
      });
  ...
  const allShortlistedSelected =
    ...
    shortlistedCandidates.every((candidate) =>
    ...
    () => [
      {
        ...
        header: () => (
          <Checkbox
            ...
            indeterminate={selectedIds.length > 0 && !allShortlistedSelected}
  ...
  return (
    <>
      ...
      <Text size="sm" c="dimmed" mb="md">
        Mark students as shortlisted first, then select them to schedule the
        next round from this page.
      </Text>
