...
import {
  Alert, Badge, Button, Card, Container, FileInput, Grid, Group, Modal, Progress,
  ScrollArea, Select, Stack, Stepper, Table, Text, TextInput, Textarea, ThemeIcon, Title, Tooltip,
} from "@mantine/core";
import {
  CaretLeft, CaretRight, Check, Database, Download, FileXls, GraduationCap, Info, Upload, User, Users, Warning,
...
AddStudentsModal.propTypes = {
  ...
  addMode: PropTypes.any,
  allocationSummary: PropTypes.any,
  ...
  manualFormData: PropTypes.any,
  nextStep: PropTypes.func,
  prevStep: PropTypes.func,
  processedBatchData: PropTypes.any,
  selectedBatchYear: PropTypes.any,
  selectedPhdSemester: PropTypes.any,
