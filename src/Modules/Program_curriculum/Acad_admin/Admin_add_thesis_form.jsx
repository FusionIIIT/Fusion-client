...
function Admin_add_thesis_form() {
  const form = useForm({
    initialValues: {
      code: "",
      name: "",
  ...
  const handleSubmit = async (values) => {
    const apiUrl = `${host}/programme_curriculum/api/admin_add_thesis/`;
    ...
    try {
        ...
        notifications.show({
          ...
          message: (
            <div>
              <Text size="sm" mb={8}>
                <strong>
                  Thesis "{values.name}" ({values.code}) has been created.
                </strong>
              </Text>
          ...
          message: (
            <div>
              <Text size="sm" mb={8}>
                <strong>
                  {errorData.error ||
                    "Unable to create thesis. Please try again."}
                </strong>
              </Text>
            </div>
          ),
      ...
      notifications.show({
        ...
        message: (
          <div>
            <Text size="sm" mb={8}>
              <strong>Connection error occurred while adding thesis.</strong>
            </Text>
            <Text size="xs" c="gray.7">
...
export default Admin_add_thesis_form;
