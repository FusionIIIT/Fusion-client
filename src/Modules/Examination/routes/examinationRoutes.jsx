...
export const announcement_students = `${host}/examination/api/announcement-students/`;
export const publish_result_selected = `${host}/examination/api/publish-result-selected/`;
