...
export const Withdraw_Bonafide = `${host}/otheracademic/api/withdraw-bonafide/`;
...
export const Withdraw_UG_Leave = `${host}/otheracademic/api/withdraw-ug-leave/`;
export const Withdraw_PG_Leave = `${host}/otheracademic/api/withdraw-pg-leave/`;
