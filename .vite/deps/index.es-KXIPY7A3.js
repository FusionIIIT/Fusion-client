...
var require_object_property_is_enumerable = __commonJS({
  "node_modules/core-js/internals/object-property-is-enumerable.js"(exports) {
    ...
    var NASHORN_BUG =
      getOwnPropertyDescriptor3 && !$propertyIsEnumerable.call({ 1: 2 }, 1);
...
var require_function_uncurry_this = __commonJS({
  "node_modules/core-js/internals/function-uncurry-this.js"(exports, module) {
    ...
    var uncurryThisWithBind =
      NATIVE_BIND && FunctionPrototype.bind.bind(call4, call4);
    module.exports = NATIVE_BIND
      ? uncurryThisWithBind
      : function (fn) {
          return function () {
...
var require_shared_store = __commonJS({
  "node_modules/core-js/internals/shared-store.js"(exports, module) {
    ...
    var store = (module.exports =
      globalThis3[SHARED] || defineGlobalProperty(SHARED, {}));
      ...
      : function getOwnPropertyDescriptor3(O2, P) {
          ...
          if (hasOwn(O2, P))
            return createPropertyDescriptor(
              !call4(propertyIsEnumerableModule.f, O2, P),
              O2[P],
            );
        };
  },
...
var require_weak_map_basic_detection = __commonJS({
  "node_modules/core-js/internals/weak-map-basic-detection.js"(
    ...
    module.exports =
      isCallable2(WeakMap) && /native code/.test(String(WeakMap));
  },
});
...
var require_make_built_in = __commonJS({
  "node_modules/core-js/internals/make-built-in.js"(exports, module) {
    ...
    Function.prototype.toString = makeBuiltIn(function toString7() {
      return (
        (isCallable2(this) && getInternalState(this).source) ||
        inspectSource(this)
      );
    }, "toString");
  },
    ...
    module.exports =
      ...
      function ownKeys2(it) {
        ...
        return getOwnPropertySymbols
          ? concat2(keys, getOwnPropertySymbols(it))
          : keys;
      };
  },
});
    ...
    module.exports = TO_STRING_TAG_SUPPORT
      ...
      : function (it) {
          ...
          return it === void 0
            ...
            : it === null
              ? "Null"
              : typeof (tag = tryGet((O2 = $Object(it)), TO_STRING_TAG)) ==
                  "string"
                ? tag
                : CORRECT_ARGUMENTS
                  ? classofRaw(O2)
                  : (result = classofRaw(O2)) === "Object" &&
                      isCallable2(O2.callee)
                    ? "Arguments"
                    : result;
        };
  },
...
var require_microtask = __commonJS({
  "node_modules/core-js/internals/microtask.js"(exports, module) {
    ...
    var MutationObserver =
      globalThis3.MutationObserver || globalThis3.WebKitMutationObserver;
    var document2 = globalThis3.document;
    var process2 = globalThis3.process;
...
var require_promise_constructor_detection = __commonJS({
  "node_modules/core-js/internals/promise-constructor-detection.js"(
    ...
    var NATIVE_PROMISE_REJECTION_EVENT = isCallable2(
      globalThis3.PromiseRejectionEvent,
    );
...
var require_es_promise_constructor = __commonJS({
  "node_modules/core-js/modules/es.promise.constructor.js"() {
    ...
    var DISPATCH_EVENT = !!(
      document2 &&
      document2.createEvent &&
      globalThis3.dispatchEvent
    );
    ...
    var onUnhandled = function (state) {
      call4(task, globalThis3, function () {
        ...
        if (IS_UNHANDLED) {
          ...
          state.rejection =
            IS_NODE2 || isUnhandled(state) ? UNHANDLED : HANDLED;
      ...
      Internal.prototype = defineBuiltIn2(
        ...
        function then(onFulfilled, onRejected) {
          ...
          var reaction = newPromiseCapability(
            speciesConstructor2(this, PromiseConstructor),
          );
          state.parent = true;
...
var require_is_array_iterator_method = __commonJS({
  "node_modules/core-js/internals/is-array-iterator-method.js"(
    ...
    module.exports = function (it) {
      return (
        it !== void 0 &&
        (Iterators.Array === it || ArrayPrototype[ITERATOR2] === it)
      );
    };
  },
});
...
var require_get_iterator_method = __commonJS({
  "node_modules/core-js/internals/get-iterator-method.js"(exports, module) {
    ...
    module.exports = function (it) {
      if (!isNullOrUndefined(it))
        return (
          getMethod4(it, ITERATOR2) ||
          getMethod4(it, "@@iterator") ||
    ...
    module.exports = function (iterable, unboundFunction, options) {
      ...
      var callFn = function (value2) {
        if (AS_ENTRIES) {
          anObject5(value2);
          return INTERRUPTED
            ? fn(value2[0], value2[1], stop)
            : fn(value2[0], value2[1]);
        }
      ...
      if (IS_RECORD) {
        ...
        if (isArrayIteratorMethod(iterFn)) {
          for (
            index2 = 0, length = lengthOfArrayLike(iterable);
            length > index2;
            index2++
          ) {
      ...
      },
      {
        race: function race(iterable) {
          ...
          var result = perform(function () {
            var $promiseResolve = aCallable(C.resolve);
            iterate(iterable, function (promise) {
              call4($promiseResolve, C, promise).then(
                capability.resolve,
                reject,
              );
            });
...
var require_iterator_define = __commonJS({
  "node_modules/core-js/internals/iterator-define.js"(exports, module) {
    ...
    module.exports = function (
      ...
      if (
        (!IS_PURE3 || FORCED3) &&
        IterablePrototype[ITERATOR2] !== defaultIterator
      ) {
...
var require_dom_token_list_prototype = __commonJS({
  "node_modules/core-js/internals/dom-token-list-prototype.js"(
    ...
    module.exports =
      DOMTokenListPrototype2 === Object.prototype
        ? void 0
        : DOMTokenListPrototype2;
  },
});
...
var require_raf = __commonJS({
  "node_modules/raf/index.js"(exports, module) {
    ...
    for (i2 = 0; !raf && i2 < vendors.length; i2++) {
      ...
      caf =
        root[vendors[i2] + "Cancel" + suffix] ||
        root[vendors[i2] + "CancelRequest" + suffix];
    }
    var i2;
    if (!raf || !caf) {
  ...
  function (MATCH, nativeMatch, maybeCallNative) {
    return [
      ...
      function match(regexp) {
        ...
        return matcher
          ? call(matcher, regexp, O2)
          : new RegExp(regexp)[MATCH](toString(O2));
      },
  ...
  function (_2, nativeReplace, maybeCallNative) {
    ...
    return [
      ...
      function replace(searchValue, replaceValue) {
        ...
        var replacer = isObject2(searchValue)
      ...
      function (string, replaceValue) {
        ...
        if (global2) {
          fullUnicode =
            !!~stringIndexOf2(flags, "u") || !!~stringIndexOf2(flags, "v");
          rx.lastIndex = 0;
        }
        var results = [];
        var result;
        while (true) {
          ...
          if (matchStr === "")
            rx.lastIndex = advanceStringIndex2(
              S,
              toLength2(rx.lastIndex),
              fullUnicode,
            );
        }
...
$(
  ...
  },
  {
    startsWith: function startsWith(searchString) {
      ...
      var index2 = toLength3(
        min2(arguments.length > 1 ? arguments[1] : void 0, that.length),
      );
...
$3(
  ...
  },
  {
    endsWith: function endsWith(searchString) {
      ...
      var len = that.length;
      var end =
        endPosition === void 0 ? len : min3(toLength4(endPosition), len);
...
var fixRegExpWellKnownSymbolLogic3 =
  require_fix_regexp_well_known_symbol_logic();
  ...
  function (SPLIT, nativeSplit, maybeCallNative) {
    ...
    return [
      ...
      function split(separator, limit) {
        ...
        var splitter = isObject3(separator)
          ? getMethod3(separator, SPLIT)
          : void 0;
        return splitter
      ...
      function (string, limit) {
        ...
        var unicodeMatching =
          !!~stringIndexOf3(flags, "u") || !!~stringIndexOf3(flags, "v");
        if (UNSUPPORTED_Y) {
        ...
        while (q < S.length) {
          ...
          if (
            z === null ||
            (e2 = min4(
              toLength5(splitter.lastIndex + (UNSUPPORTED_Y ? q : 0)),
              S.length,
            )) === p2
          ) {
...
var n = Math.PI;
function o(t2, r2, e2) {
  ((t2.lArcFlag = 0 === t2.lArcFlag ? 0 : 1),
    (t2.sweepFlag = 0 === t2.sweepFlag ? 0 : 1));
  var a2 = t2.rX,
    o2 = t2.rY,
    s2 = t2.x,
    u2 = t2.y;
  ...
  (1 < p2 && ((a2 *= Math.sqrt(p2)), (o2 *= Math.sqrt(p2))),
    ...
    (t2.rY = o2));
  var m3 =
      Math.pow(a2, 2) * Math.pow(y2, 2) + Math.pow(o2, 2) * Math.pow(c3, 2),
    O2 =
        ...
        if (
          ...
          if (0 === T2)
            ...
            var v2 = (a2.xRot * Math.PI) / 180,
              ...
              L = Math.cos(I);
            ((a2.rX =
              Math.abs(T2) / Math.sqrt(M * l3(L) + R * S * L + g * l3(S))),
              (a2.rY =
                Math.abs(T2) / Math.sqrt(M * l3(S) - R * S * L + g * l3(L))),
      ...
      var t3 = function (t4) {
        ...
        c3 = u2(function (r3, e3, n3) {
          ...
          if (
            ...
            (O3(u3.x), l3(u3.y));
            for (
              var T2 = 0, v2 = p(e3, u3.x1, u3.x2, u3.x);
              T2 < v2.length;
              T2++
            ) {
...
var v = function (t2) {
  return (
    "0".charCodeAt(0) <= t2.charCodeAt(0) &&
    t2.charCodeAt(0) <= "9".charCodeAt(0)
  );
};
var f = (function (t2) {
  function e2() {
...
function vectorsRatio(u2, v2) {
  return (
    (u2[0] * v2[0] + u2[1] * v2[1]) /
    (vectorMagnitude(u2) * vectorMagnitude(v2))
  );
}
function vectorsAngle(u2, v2) {
  return (
    (u2[0] * v2[1] < u2[1] * v2[0] ? -1 : 1) * Math.acos(vectorsRatio(u2, v2))
  );
}
function CB1(t2) {
  return t2 * t2 * t2;
    ...
    if (!ignoreAnimation) {
      ...
      var shouldUpdate = this.animations.reduce(
        (shouldUpdate2, animation) =>
          animation.update(frameDuration) || shouldUpdate2,
        false,
      );
      if (shouldUpdate) {
        return true;
...
var PathElement = class _PathElement extends RenderedElement {
  ...
  pathC(ctx, boundingBox) {
    var { pathParser } = this;
    var { current, point, controlPoint, currentPoint } =
  ...
  pathQ(ctx, boundingBox) {
    var { pathParser } = this;
    var { current, controlPoint, currentPoint } =
...
var TextElement = class _TextElement extends RenderedElement {
  constructor(document2, node2, captureTextNodes) {
    super(
      document2,
      node2,
      new.target === _TextElement ? true : captureTextNodes,
    );
    this.type = "text";
    this.x = 0;
    this.y = 0;
  ...
  renderTElementChildren(ctx) {
    ...
    if (customFont) {
      ...
      for (var i2 = 0; i2 < len; i2++) {
        ...
        ctx.translate(-this.x, -this.y);
        this.x +=
          (fontSize * (glyph.horizAdvX || customFont.horizAdvX)) / unitsPerEm;
...
var TSpanElement = class _TSpanElement extends TextElement {
  constructor(document2, node2, captureTextNodes) {
    super(
      document2,
      node2,
      new.target === _TSpanElement ? true : captureTextNodes,
    );
    this.type = "tspan";
  ...
  setTextData(ctx) {
    ...
    for (var i2 = 0; i2 < textLen; i2++) {
      letterSpacingCache.push(
        typeof dx[i2] !== "undefined" ? dx[i2] : letterSpacing,
      );
    }
  ...
  constructor(document2, node2, captureTextNodes) {
    ...
    cssDefs.forEach((_2) => {
      ...
      cssClasses.forEach((_3) => {
        ...
        document2.stylesSpecificity[cssClass] =
...
svg-pathdata/lib/SVGPathData.module.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=index.es-KXIPY7A3.js.map
