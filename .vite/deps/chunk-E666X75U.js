import { require_prop_types } from "./chunk-RW5PX2K4.js";
import { _extends, _objectWithoutPropertiesLoose } from "./chunk-VCHV22QC.js";
...
function getChildMapping(children2, mapFn) {
  var mapper = function mapper2(child) {
    return mapFn && (0, import_react3.isValidElement)(child)
      ? mapFn(child)
      : child;
  };
...
function getNextChildMapping(nextProps, prevChildMapping, onExited) {
  ...
  Object.keys(children2).forEach(function (key) {
    ...
    var isLeaving =
      (0, import_react3.isValidElement)(prevChild) && !prevChild.props.in;
    if (hasNext && (!hasPrev || isLeaving)) {
      ...
      hasNext &&
      hasPrev &&
      (0, import_react3.isValidElement)(prevChild)
    ) {
      children2[key] = (0, import_react3.cloneElement)(child, {
        onExited: onExited.bind(null, child),
...
//# sourceMappingURL=chunk-E666X75U.js.map
