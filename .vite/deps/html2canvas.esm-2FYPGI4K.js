  ...
  var forbiddenBreakpoints =
    options.wordBreak === "keep-all"
      ? isLetterNumber.map(function (letterNumber, i) {
          return (
            letterNumber && codePoints[i] >= 19968 && codePoints[i] <= 40959
          );
        })
      : void 0;
          ...
          ix =
            this.index[
              UTRIE2_LSCP_INDEX_2_OFFSET +
                ((codePoint - 55296) >> UTRIE2_SHIFT_2)
            ];
          ix = (ix << UTRIE2_INDEX_SHIFT) + (codePoint & UTRIE2_DATA_MASK);
          return this.data[ix];
        }
...
var BoundCurves =
  ...
  /* @__PURE__ */ (function () {
    function BoundCurves2(element) {
      ...
      var paddingTop2 = getAbsoluteValue(
        styles.paddingTop,
      ...
      this.topRightPaddingBox =
        trh > 0 || trv > 0
          ? getCurvePoints(
              bounds.left +
                Math.min(topWidth, bounds.width - borderRightWidth2),
              bounds.top + borderTopWidth2,
      ...
      this.bottomRightContentBox =
        brh > 0 || brv > 0
          ...
          : new Vector(
              ...
              bounds.top +
                bounds.height -
                (borderBottomWidth2 + paddingBottom2),
            );
...
var CanvasRenderer =
  ...
  (function (_super) {
    ...
    CanvasRenderer2.prototype.renderNodeBackgroundAndBorders = function (
      paint,
    ) {
      return __awaiter(this, void 0, void 0, function () {
        var styles,
      ...
      switch (_u.label) {
        case 0:
          ...
          resourceOptions = {
            ...
            imageTimeout:
              (_c = opts.imageTimeout) !== null && _c !== void 0 ? _c : 15e3,
            proxy: opts.proxy,
