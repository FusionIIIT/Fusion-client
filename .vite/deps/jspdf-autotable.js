      ...
      (_b =
        (_a2 =
          element === null || element === void 0
            ? void 0
            : element.parentElement) === null || _a2 === void 0
          ? void 0
...
function parseSettings(doc, options) {
  ...
  var startY =
    (_a2 = getStartY(doc, options.startY)) !== null && _a2 !== void 0
      ? _a2
      : margin.top;
  var showFoot;
  if (options.showFoot === true) {
    ...
    showFoot =
      (_b = options.showFoot) !== null && _b !== void 0 ? _b : "everyPage";
  }
  var showHead;
  if (options.showHead === true) {
    ...
    showHead =
      (_c = options.showHead) !== null && _c !== void 0 ? _c : "everyPage";
  }
  ...
  return {
    includeHiddenHtml:
      (_f = options.includeHiddenHtml) !== null && _f !== void 0 ? _f : false,
    useCss,
    theme,
    startY,
    margin,
    ...
    rowPageBreak:
      (_h = options.rowPageBreak) !== null && _h !== void 0 ? _h : "auto",
    tableWidth:
      (_j = options.tableWidth) !== null && _j !== void 0 ? _j : "auto",
    showHead,
    showFoot,
    tableLineWidth:
      (_k = options.tableLineWidth) !== null && _k !== void 0 ? _k : 0,
    tableLineColor:
      (_l = options.tableLineColor) !== null && _l !== void 0 ? _l : 200,
    horizontalPageBreak,
    horizontalPageBreakRepeat,
    horizontalPageBreakBehaviour:
      (_m = options.horizontalPageBreakBehaviour) !== null && _m !== void 0
        ? _m
        : "afterAllRows",
  };
}
function getStartY(doc, userStartY) {
  ...
  if (typeof userStartY === "number") {
    ...
    if (
      ...
      (previous === null || previous === void 0 ? void 0 : previous.finalY) !=
        null
    ) {
...
function parseContent$1(doc, options, window2) {
  ...
  if (options.html) {
    ...
    if (window2) {
      var htmlContent =
        parseHtml(doc, options.html, window2, hidden, options.useCss) || {};
  ...
  Object.keys(firstRow)
    ...
    .forEach(function (key) {
      ...
      if (typeof input === "object" && !Array.isArray(input)) {
        colSpan =
          (input === null || input === void 0 ? void 0 : input.colSpan) || 1;
      }
...
var Table =
  ...
  (function () {
    ...
    Table2.prototype.callCellHooks = function (
      doc,
      handlers,
      cell,
      row,
  ...
  (function () {
    ...
    Row2.prototype.getMaxCellHeight = function (columns) {
      ...
      return columns.reduce(function (acc, column) {
        ...
        return Math.max(
          acc,
          ((_a2 = _this.cells[column.index]) === null || _a2 === void 0
            ? void 0
            : _a2.height) || 0,
        );
      }, 0);
...
var Cell =
  ...
  (function () {
    ...
    Cell2.prototype.getContentHeight = function (
      scaleFactor,
      lineHeightFactor,
    ) {
...
function getColumnsCanFitInPage(doc, table, config) {
  ...
  var first = true;
  var i =
    (_a2 = config === null || config === void 0 ? void 0 : config.start) !==
      null && _a2 !== void 0
      ? _a2
      : 0;
...
try {
  if (typeof window !== "undefined" && window) {
    ...
    jsPDF =
      anyWindow.jsPDF ||
      ((_a = anyWindow.jspdf) === null || _a === void 0 ? void 0 : _a.jsPDF);
    if (jsPDF) {
      applyPlugin(jsPDF);
    }
  }
