...
var CFB = (function _CFB() {
  ...
  function bit_swap_8(n) {
    var t =
      (((n << 1) | (n << 11)) & 139536) | (((n << 5) | (n << 15)) & 558144);
  ...
  function dyn(data, boff) {
    ...
    for (i2 = 0; i2 < L; ++i2)
      if ((ccode = clens[i2]) != 0) ctree[i2] = next_code[ccode]++;
    var cleni = 0;
    for (i2 = 0; i2 < L; ++i2) {
      cleni = clens[i2];
      if (cleni != 0) {
...
var unescapexml = /* @__PURE__ */ (function () {
  ...
  return function unescapexml2(text) {
    ...
    var j = s.indexOf("]]>");
    return (
      unescapexml2(s.slice(0, i)) +
      s.slice(i + 9, j) +
      unescapexml2(s.slice(j + 3))
    );
  };
})();
var decregex = /[&<>'"]/g;
...
function utf8reada(orig) {
  ...
  while (i < orig.length) {
    ...
    f = orig.charCodeAt(i++);
    w =
      (((c & 7) << 18) | ((d & 63) << 12) | ((e & 63) << 6) | (f & 63)) - 65536;
...
function xlml_normalize(d) {
  if (
    has_buf /*::typeof Buffer !== "undefined" && d != null && d instanceof Buffer &&*/ &&
    Buffer.isBuffer(d)
  )
...
function encode_range_xls(r, opts) {
  if (r.s.r == 0 && !r.s.rRel) {
    if (
      r.e.r == (opts.biff >= 12 ? 1048575 : opts.biff >= 8 ? 65536 : 16384) &&
      !r.e.rRel
    ) {
      return (
        (r.s.cRel ? "" : "$") +
...
var _XLSIcv = rgbify([
  ...
  0, 16777215, 16711680, 65280, 255, 16776960, 16711935, 65535, 8388608, 32768,
  128, 8421376, 8388736, 32896, 12632256, 8421504, 10066431, 10040166, 16777164,
  13434879, 6684774, 16744576, 26316, 13421823, 128, 16711935, 16776960, 65535,
  8388736, 8388608, 32896, 255, 52479, 13434879, 13434828, 16777113, 10079487,
  16751052, 13408767, 16764057, 3368703, 3394764, 10079232, 16763904, 16750848,
  16737792, 6710937, 9868950, 13158, 3381606, 13056, 3355392, 10040064,
  10040166, 3355545, 3355443, /* Other entries to appease BIFF8/12 */
...
function write_PropertySet(entries, RE, PIDSI) {
  ...
  for (i = 0; i < entries.length; ++i) {
    ...
    if (
      ...
      PseudoPropsPairs.indexOf(entries[i][0]) > -1
    )
      continue;
...
var ETH = (function () {
  ...
  function sheet_to_eth_data(ws) {
    ...
    o.push(
      "sheet:c:" + (r.e.c - r.s.c + 1) + ":r:" + (r.e.r - r.s.r + 1) + ":tvf:1",
    );
...
var crypto_CreateXorArray_Method1 = /* @__PURE__ */ (function () {
  ...
  var XorMatrix = [
    ...
    50935, 40399, 11199, 17763, 35526, 1453, 2906, 5812, 11624, 23248, 885,
    1770, 3540, 7080, 14160, 28320, 56640, 55369, 41139, 20807, 41614, 21821,
    43642, 17621, 28485, 56970, 44341, 19019, 38038, 14605, 29210, 60195, 50791,
    40175, 10751, 21502, 43004, 24537, 18387, 36774, 3949, 7898, 15796, 31592,
    63184, 47201, 24803, 49606, 37805, 14203, 28406, 56812, 17824, 35648, 1697,
    3394, 6788, 13576, 27152, 43601, 17539, 35078, 557, 1114, 2228, 4456, 30388,
    60776, 51953, 34243, 7079, 14158, 28316, 14128, 28256, 56512, 43425, 17251,
    34502, 7597, 13105, 26210, 52420, 35241, 883, 1766, 3532, 4129, 8258, 16516,
    33032, 4657, 9314, 18628,
  ];
  ...
  people.forEach(function (person, idx) {
    o.push(
      writextag("person", null, {
        displayName: person,
        id:
          "{54EE7950-7262-4200-6969-" + ("000000000000" + idx).slice(-12) + "}",
        userId: person,
        providerId: "None",
      }),
    );
...
function get_ixti_raw(supbooks, ixti, opts) {
  ...
  switch (supbooks[XTI[0]][0][0]) {
    ...
    default:
      ...
      o =
        XTI[1] == -1 ? "#REF" : supbooks[XTI[0]][0][3][XTI[1]] || "SH33TJSERR4";
  ...
  return function parse_ws_xml_data2(sdata, s, opts, guess, themes, styles) {
    ...
    for (
      ...
      for (ri = 0; ri != cells.length; ++ri) {
        ...
        p = { t: "" };
        if (
          (cref = d.match(match_v)) != null /*::cref != null && */ &&
          cref[1] !== ""
        )
          p.v = unescapexml(cref[1]);
        if (opts.cellFormula) {
          if (
            (cref = d.match(match_f)) != null /*::cref != null && */ &&
            cref[1] !== ""
          ) {
...
function write_xls_props(wb, cfb) {
  ...
  for (i = 0; i < CEntries.length; ++i) {
    if (
      ...
      PseudoPropsPairs.indexOf(CEntries[i][0]) > -1
    )
      continue;
...
function readDecimal128LE(buf, offset) {
  ...
  return (
    (buf[offset + 15] & 128 ? -mantissa : mantissa) * Math.pow(10, exp - 6176)
  );
}
...
function parse_TST_TileRowInfo(u8, type) {
  ...
  var wide_offsets =
    (((_b = (_a = pb[8]) == null ? void 0 : _a[0]) == null
      ? void 0
      : _b.data) &&
  ...
  if (
    ((_d = (_c = pb[7]) == null ? void 0 : _c[0]) == null ? void 0 : _d.data) &&
    type != 0
  ) {
    used_storage_u8 =
...
function parse_TST_Tile(M, root) {
  var _a;
  var pb = parse_shallow(root.data);
  var storage = ((_a = pb == null ? void 0 : pb[7]) == null ? void 0 : _a[0])
...
function parse_TST_TableModelArchive(M, root, ws) {
  ...
  var sst = parse_TST_TableDataList(
    M,
    M[parse_TSP_Reference(store[4][0].data)][0],
  );
  var rsst = ((_a = store[17]) == null ? void 0 : _a[0])
      ...
      if (mtype == 2) {
        ...
        root2.sheets.forEach(function (sheet, idx) {
          book_append_sheet(
            out,
            sheet,
            idx == 0 ? root2.name : root2.name + "_" + idx,
            true,
          );
        });
      }
...
function parse_numbers_iwa(cfb) {
  ...
  var docroot =
    ((_d =
      (_c =
        (_b = (_a = M == null ? void 0 : M[1]) == null ? void 0 : _a[0]) == null
          ? void 0
          : _b.meta) == null
        ? void 0
        : _c[1]) == null
...
function write_tile_row(tri, data, SST) {
  var _a, _b, _c, _d;
  if (
    !((_a = tri[6]) == null ? void 0 : _a[0]) ||
    !((_b = tri[7]) == null ? void 0 : _b[0])
  )
    throw "Mutation only works on post-BNC storages!";
  var wide_offsets =
    (((_d = (_c = tri[8]) == null ? void 0 : _c[0]) == null
      ? void 0
      : _d.data) &&
