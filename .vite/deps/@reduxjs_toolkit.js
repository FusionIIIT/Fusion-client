...
function isPlainObject2(value) {
  ...
  if (proto2 === null || proto2 === O[PROTOTYPE]) return true;
  const Ctor =
    O.hasOwnProperty.call(proto2, CONSTRUCTOR) && proto2[CONSTRUCTOR];
...
function generatePatchesAndFinalize(state, rootScope) {
  ...
  const shouldFinalize =
    ...
    (state.type_ === 3 ||
      ...
      (((_a = state.assigned_) == null ? void 0 : _a.size) ?? 0) > 0);
  if (shouldFinalize) {
...
var objectTraps = {
  get(state, prop) {
    ...
    if (isArrayWithStringProp) {
      if (
        arrayPlugin == null ? void 0 : arrayPlugin.isArrayOperationMethod(prop)
      ) {
  ...
  set(state, prop, value) {
    ...
    if (!state.modified_) {
      ...
      if (
        is(value, current2) &&
        (value !== void 0 || has(state.base_, prop, state.type_))
      )
        return true;
      prepareCopy(state);
      markChanged(state);
...
function createProxy(rootScope, value, parent, key) {
  ...
  if (parent && key !== void 0) {
    ...
    state.callbacks_.push(function rootDraftCleanup(rootScope2) {
      var _a;
      (_a = rootScope2.mapSetPlugin_) == null
        ? void 0
        : _a.fixSetContents(state);
