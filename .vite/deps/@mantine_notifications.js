import {
  ...
  Transition_default,
} from "./chunk-E666X75U.js";
import "./chunk-RW5PX2K4.js";
import {
  Box,
  Combination_default,
  Notification,
...
function updateNotificationsState(store, update) {
  ...
  const updated = getDistributedNotifications(
    notifications2,
...
function showNotification(notification, store = notificationsStore) {
  ...
  updateNotificationsState(store, (notifications2) => {
    if (
      notification.id &&
      notifications2.some((n) => n.id === notification.id)
    ) {
  ...
  updateNotificationsState(store, (notifications2) =>
    notifications2.filter((notification) => {
      ...
      if (notification.id === id) {
        (_a = notification.onClose) == null
          ? void 0
          : _a.call(notification, notification);
        return false;
      }
      return true;
    }),
...
function cleanNotificationsQueue(store = notificationsStore) {
  updateNotificationsState(store, (notifications2) =>
    notifications2.slice(0, store.getState().limit),
  );
}
var notifications = {
...
var Notifications = factory((_props, ref) => {
      ...
      ({ style: notificationStyle, ...notification }) =>
        (0, import_jsx_runtime2.jsx)(
          Transition,
          {
            ...
            children: (state) =>
              (0, import_jsx_runtime2.jsx)(NotificationContainer, {
                ref: (node) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(OptionalPortal, {
    withinPortal,
    ...portalProps,
    children: [
      ...
      (0, import_jsx_runtime2.jsx)(Box, {
        ...getStyles("root", {
          className: Combination_default.classNames.fullWidth,
        }),
